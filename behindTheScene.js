...
var name = "John"; //the varrisable is in Global execution context
...
variable object(VO)[[Hoisting ==> [creation of variable object and code scaned and for:
a function is set or pointed to before beign created,
a variable is set to undefined]]]
scope chain[creatiion of the scope chain]
...
// lexical scoping : a functiion that is lexically within another function gets access to the scope of the outer function.
